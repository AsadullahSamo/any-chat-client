        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <form className='flex flex-col gap-5'>
              <input name="name" value={userDetails.name} placeholder='Enter the name' onChange={handleChange} type='text' maxLength={1000} className={`text-black text-[12px] md:text-sm self-center ${font.poppinsMedium} bg-[#f5f7fb] rounded-2xl shadow-lg mx-0 md:mx-2 -ml-6 md:-ml-0 pl-2 md:pl-4 w-[100%] md:w-[88%] h-12 border-2 border-solid border-[#d8dbe3] focus:outline-none focus:border-2 focus:border-solid focus:border-[#edf0f8] focus:transition-all focus:duration-500`} required/>
              <input name="phone" value={userDetails.phone} placeholder='Enter the phone number with country code' onChange={handleChange} type='text' pattern='((\+|00)?[1-9]{2}|0)[1-9]( ?[0-9]){8}' className={`text-black text-[12px] md:text-sm self-center ${font.poppinsMedium} bg-[#f5f7fb] rounded-2xl shadow-lg md:mx-2 -ml-6 md:-ml-0 pl-2 md:pl-4 w-[100%] md:w-[88%] h-12 border-2 border-solid border-[#d8dbe3] focus:outline-none focus:border-2 focus:border-solid focus:border-[#edf0f8] focus:transition-all focus:duration-500`} />
