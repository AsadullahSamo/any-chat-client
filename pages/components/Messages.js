                ...
                <>
                    ...
                    <>
                        ...
                        <div className={`mt-5 rounded-tr-3xl rounded-tl-3xl rounded-br-3xl`}>   
                            <div className={`${user.name === nickname ? 'flex justify-end mr-2 md:mr-10' : 'ml-2 md:ml-10'}`}><Card name={user.name} nickname={nickname} messagePart={user.message.substring(0, user.message.indexOf("http"))} siteUrl={user.message.substring(user.message.indexOf("http"))} /></div>                                
                        </div>
