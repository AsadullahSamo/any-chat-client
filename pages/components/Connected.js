...
export default function Connected() {
    ...
    useEffect(() => {
      ...
      fetch(`https://any-chat-server-gt1k.onrender.com/users`)
      .then(res => res.json())
      .then(data => {
      ...
      fetch(`https://any-chat-server-gt1k.onrender.com/users/all`)
      .then(res => res.json())
      .then(data => {
    ...
    useEffect(() => {
        fetch(`https://any-chat-server-gt1k.onrender.com/myContacts/${myUserID}`)
        .then(res => res.json())
        .then(data => {
    ...
    useEffect(() => {
      const newSocket = io('https://any-chat-server-gt1k.onrender.com');
      setSocket(newSocket)
    ...
    const handleFileChange = (e) => {
        ...
        fetch('https://any-chat-server-gt1k.onrender.com/upload', {
            method: 'POST',
            body: formData,
        })
